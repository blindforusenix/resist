...
#The Nested Admin is used because Choice>Questions>Election inline will not work for multiple levels of inline with basic Django Admin.
from nested_admin import NestedModelAdmin, NestedStackedInline, NestedTabularInline
# Register your models here.
from .models import Election, Voter, Trustee, Question, Choice, RegistrationTeller
...
class RegistrationTellerInline(NestedTabularInline):
    fieldsets = [
        ('Name', {'fields':['name']}),
        ('Email', {'fields':['email']}),
    ]
...
class ElectionAdmin(NestedModelAdmin):
    ...
    inlines = [QuestionInline, TrusteeInline, RegistrationTellerInline, ]
